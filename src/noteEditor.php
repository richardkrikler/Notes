...
<textarea form="save-form" id="content-textarea" name="content" class="editor-area container-lg h-100 px-3 py-5 border-0" placeholder="Start writing..." onkeydown="editorHelper(event)">{$note_content}</textarea>
NOTE_CONTENT;
